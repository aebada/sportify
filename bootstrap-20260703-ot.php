<?php
/**
 * OnlyTalents bootstrap 20260703-ot-live — fresh filename bypasses stale OPcache (2026-07-03).
 */
...
if (in_array($__sportifyHost, ['talents.sportifyplus.de', 'onlytalents.sportifyplus.de'], true)
    ...
    foreach ([
        ...
        __DIR__ . '/app/Support/helpers-20260703-ot-live.php',
...
if (PHP_SAPI !== 'cli' && function_exists('opcache_invalidate')) {
    foreach ([
        ...
        $root . '/app/Support/helpers-20260703-ot-live.php',
