<?php
/**
 * RefereeX AI — root-level PHP entry (bypasses frozen public/index.php OPcache).
 * deploy-marker: refereex-root-live-20260705
 */
...
header('X-Sportify-RefereeX: root-live-20260705');
...
foreach ([
    ...
    $root . '/public/index-20260705-refereex-live.php',
