 ...
 * deploy-marker: memberships-v1-isPost-fix
 */
...
$router->get('/auth/facebook', [OAuthController::class, 'facebook'], 'auth.facebook');
$router->get('/auth/facebook/callback', [OAuthController::class, 'facebookCallback'], 'auth.facebook.callback');
