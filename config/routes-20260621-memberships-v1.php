<?php
/**
 * Route definitions — memberships admin fix (2026-06-21).
 * deploy-marker: memberships-v1-isPost-fix ot-canonical-20260707
 */

use App\Controllers\HomeController20260621Roles;
...
$router->get('/', [HomeController20260621Roles::class, 'index'], 'home');
...
$router->get('/watch-live-today', [TvScheduleController::class, 'liveStreams'], 'live_streams.watch_today');
...
// Legacy alias — some hosts block /admin/memberships at the edge (empty 500).
...
// RefereeX AI flagship product page
...
$router->get('/auth/google', [GoogleLoginController::class, 'start'], 'auth.google');
$router->get('/auth/google/callback', [GoogleLoginController::class, 'returned'], 'auth.google.callback');
