<?php
/**
 * OnlyTalents bootstrap 20260705-ot — fresh filename bypasses stale OPcache (2026-07-03).
 */
...
if (in_array($__sportifyHost, ['talents.sportifyplus.de', 'onlytalents.sportifyplus.de'], true)
    ...
    foreach ([
        ...
        __DIR__ . '/app/Support/helpers-20260705.php',
...
if (PHP_SAPI !== 'cli' && function_exists('opcache_invalidate')) {
    foreach ([
        ...
        $root . '/app/Support/helpers-20260705.php',
...
require $root . '/app/Support/helpers-20260705.php';
